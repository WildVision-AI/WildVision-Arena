...
Usage:
python3 -m arena.serve.cli --model lmsys/vicuna-7b-v1.5
python3 -m arena.serve.cli --model lmsys/fastchat-t5-3b-v1.0
...
from arena.model.model_adapter import add_model_args
...
from arena.serve.inference import ChatIO, chat_loop
from arena.utils import str_to_torch_dtype
