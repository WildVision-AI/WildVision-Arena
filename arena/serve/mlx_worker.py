...
Code based on vllm_worker https://github.com/lm-sys/FastChat/blob/main/arena.serve/vllm_worker.py
...
from arena.serve.base_model_worker import BaseModelWorker
from arena.serve.model_worker import (
    logger,
    worker_id,
)
from arena.utils import get_context_length, is_partial_stop
