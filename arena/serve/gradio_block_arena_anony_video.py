...
def set_global_vars_anony_video(enable_moderation_):
...
def build_side_by_side_ui_anony_video(models):
    notice_markdown = f"""
    {HEADER_MD}
⛔ <span style='color: red; font-weight:800;'>Your data will be logged for research purposes. Please do not include any confidential, personal, or other sensitive information. </span> ⛔ 
    ...
    rule_markdown = f"""
## 📜 Rules
- Upload any video, and send any question to two anonymous models and vote for the better one!
- Or you could also click "Sample Input" to get a random example from public benchmarks such as VisIT-Bench.
- Single video multi-round chat is allowed, you can continue to send question until you identify a winner.
    """    
    info_markdown = f"""
    {INFO_MD}
    """
...
- Click button "Sample Input" to randomly sample the video and text input from public benchmark to a pair of anonymous models .
