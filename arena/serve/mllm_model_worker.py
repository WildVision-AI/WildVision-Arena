...
from arena.constants import ErrorCode, SERVER_ERROR_MSG
from arena.model.model_adapter import (
    load_model,
    add_model_args,
    get_generate_stream_function,
)
from arena.modules.awq import AWQConfig
...
from arena.serve.base_model_worker import BaseModelWorker, app
...
logger = build_logger("mllm_model_worker", f"mllm_model_worker_{worker_id}.log")


class MLLMModelWorker(BaseModelWorker):
    def __init__(
        self,
        controller_addr: str,
        worker_addr: str,
        ...
        **kwargs,
        ...
        self.context_len = get_context_length(self.model.config) if self.model is not None else 1024
