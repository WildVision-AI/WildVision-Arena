...
from arena.vlm_utils.videollava.mm_utils import tokenizer_image_token, process_images, get_model_name_from_path
...
def eval_model(args):
    ...
    if args.return_gating_logit:
        from arena.vlm_utils.videollava.utils import get_gating_logit_by_hook
        print(model)
